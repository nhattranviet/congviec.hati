    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Xóa thường trú Sổ tạm trú</h4>
        ...
        <div class="row">
            ...
            <div class="card-box table-responsive">
                ...
                <div class="col-xs-12 col-sm-12 m-t-10">
                    <form id="form-nhankhau" action="/tam-tru/{{ $idnhankhau }}/{{ $idsotamtru }}/post-xoa-tam-tru-nhan-khau" method="POST" role="form">
                        @csrf
                        <div class="row">
