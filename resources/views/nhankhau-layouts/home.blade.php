                            ...
                            <div class="row nhat_box_wrap m-b-10">
                                ...
                                <div class="col-xs-6 col-md-6 col-lg-6 col-xl-6 m-b-10 nhat_box_tool m-b-30">
                                    <div class="col-xs-6">
                                        ...
                                        <a href="{{ route('nhan-khau.create') }}" style="margin: 0 1.1em 0 1.1em;" class="waves-effect waves-light text-primary" data-toggle="tooltip" data-placement="top" title="Thêm mới hồ sơ hộ khẩu"> <i style="font-size: 18px;" class="zmdi zmdi-accounts-add m-r-5"></i> <span>NHẬP HỒ SƠ</span> </a>
                                        <a href="{{ URL::to('bao-cao-nhan-khau') }}" style="margin: 0 1.1em 0 1.1em;" class="waves-effect waves-light text-primary" data-toggle="tooltip" data-placement="top" title="Tìm kiếm, tra cứu thông tin nhân khẩu"> <i style="font-size: 18px;" class="zmdi zmdi-local-wc m-r-5"></i> <span>TÌM KIẾM</span> </a>
                                ...
                                <div class="col-xs-6 col-md-6 col-lg-6 col-xl-6 m-b-10 nhat_box_tool m-b-30">
                                    <div class="col-xs-6">
                                        ...
                                        <a href="{{ route('tam-tru.create') }}" style="margin: 0 1.1em 0 1.1em;" class="waves-effect waves-light text-primary" data-toggle="tooltip" data-placement="top" title="Thêm mới sổ tạm trú hộ gia đình"> <i style="font-size: 18px;" class="zmdi zmdi-accounts-add m-r-5"></i> <span>SỔ HỘ GIA ĐÌNH</span> </a>
                                        <a href="{{ route('get-add-so-tam-tru-ca-nhan') }}" style="margin: 0 1.1em 0 1.1em;" class="waves-effect waves-light text-primary" data-toggle="tooltip" data-placement="top" title="Thêm mới sổ tạm trú cá nhân"> <i style="font-size: 18px;" class="zmdi zmdi-accounts-add m-r-5"></i> <span>SỔ CÁ NHÂN</span> </a>
                                        <a href="{{ route('check-qua-han') }}" style="margin: 0 1.1em 0 1.1em;" class="waves-effect waves-light text-primary" data-toggle="tooltip" data-placement="top" title="Kiểm tra nhân khẩu quá hạn tạm trú"> <i style="font-size: 18px;" class="zmdi zmdi-calendar-close m-r-5"></i> <span>QUÁ HẠN</span> </a>
