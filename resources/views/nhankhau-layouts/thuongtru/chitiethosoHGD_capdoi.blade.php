            ...
            <div class="col-xs-12">
               <div class="card-box table-responsive">
                  ...
                  <div class="col-xs-12 col-sm-12">
                     <h4 class="m-t-0 header-title"><b>Cấp đổi hộ khẩu</b></h4>
                  ...
                  <form id="form-nhankhau" action="{{ route('post-cap-doi-SHK', $idhoso) }}" method="POST" role="form">
                    @csrf
                            ...
                            <div class="row hokhau-code">
                                ...
                                <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-3">
                                    <fieldset class="form-group">
                                        <label for="datepicker">Ngày cấp đổi <span class="text-danger">*</span></label>
                                        <div>
                                            <div class="input-group">
                                                <input value="{{ old('ngaycapdoi') }}" type="text" name="ngaycapdoi" class="form-control" placeholder="dd-mm-yyyy" id="datepicker">
                                ...
                                <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-9">
                                    <fieldset class="form-group">
                                        <label for="datepicker">Lý do/Ghi chú <span class="text-danger">*</span></label>
                                        <div>
                                            <div class="input-group">
                    ...
                    <div class="row m-t-10">
                        <div class="col-xs-12 col-sm-12">
                            <button onclick="return confirm('Bạn có muốn thực hiện thủ tục cấp đổi không?');" class="pull-left btn btn-danger"><i style="font-size: 1.2em;" class="fa fa-save"></i> Cấp đổi</button>
