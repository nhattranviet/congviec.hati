         ...
         <div class="row">
            <div class="col-xs-12">
               <div class="card-box table-responsive">
                  ...
                  <form id="form-nhankhau" action="{{ route('post-cap-lai-SHK', $idhoso) }}" method="POST" role="form">
                    @csrf
                            ...
                            <div class="row hokhau-code">
                                ...
                                <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-3">
                                    <fieldset class="form-group">
                                        <label for="datepicker">Ngày cấp lại <span class="text-danger">*</span></label>
                                        <div>
                                            <div class="input-group">
                                                <input value="{{ old('ngaycaplai') }}" type="text" name="ngaycaplai" class="form-control" placeholder="dd-mm-yyyy" id="datepicker">
                    ...
                    <div class="row m-t-10">
                        <div class="col-xs-12 col-sm-12">
                            <button onclick="return confirm('Bạn có muốn thực hiện thủ tục cấp lại không?');" class="pull-left btn btn-danger"><i style="font-size: 1.2em;" class="fa fa-save"></i> Cấp lại</button>
