                                        ...
                                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12">
                                            <fieldset class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input  id="timepicker2" type="text" name="gio" class="form-control" placeholder="Nhập giờ của công việc" value="">
                                                    <span class="input-group-addon"><i class="zmdi zmdi-time"></i></span>
                                                </div>
                                                    {{-- <div class="input-group">
                                                        <input type="text" name="gio" class="form-control" placeholder="Nhập giờ của công việc" value="">
