                        ...
                        <form id="form-nhankhaus" action="{{ route('lich-cong-tac.update_lanhdaotructuan',$id) }}" method="POST" role="form" autocomplete="off">
                            ...
                            <div class="row m-t-10">
                                <div class="col-md-12">
                                    ...
                                    <a href="{{ route('lich-cong-tac.index_lanhdaotructuan') }}" class="btn btn-danger waves-effect waves-light pull-right"><span class="btn-label"><i class="fa fa-backward"></i></span>Quay lại</a>
                                </div>
                            </div>
                            {{ csrf_field() }}
                        </form>
