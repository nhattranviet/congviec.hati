...
var addTab = function (tabIndexs) {
    ...
    // add tab content
    el = '<div role="tabpanel" class="tab-pane fade in" id="profile' + tabIndexs +
    ...
    $("#profile" + tabIndexs).find(".hokhau-code").remove();
    $("#profile" + tabIndexs).find(".tab-header h4").remove();
    // add title
    el = '<h4 class="header-title m-t-0 m-b-30">THÔNG TIN NHÂN KHẨU ' + current_nhankhau + "</h4>";
    $("#profile" + tabIndexs).find(".tab-header").append(el);
    ...
    $("#profile" + tabIndexs).find("select.select2").removeAttr('tabindex');

    var idquanhechuho_tabindex = $('#home1 select[name="idquanhechuho[]"').next().find('span.select2-selection').attr('tabindex');
    var idnghenghiep_tabindex = $('#home1 select[name="idnghenghiep[]"').next().find('span.select2-selection').attr('tabindex');
    var idtrinhdohocvan_tabindex = $('#home1 select[name="idtrinhdohocvan[]"').next().find('span.select2-selection').attr('tabindex');
    var iddantoc_tabindex = $('#home1 select[name="iddantoc[]"').next().find('span.select2-selection').attr('tabindex');
    var idtongiao_tabindex = $('#home1 select[name="idtongiao[]"').next().find('span.select2-selection').attr('tabindex');
    var idquoctich_tabindex = $('#home1 select[name="idquoctich[]"').next().find('span.select2-selection').attr('tabindex');
    $("#profile" + tabIndexs).find(".select2-container").remove();
    // alert(idtrinhdohocvan_tabindex);
    $("#profile" + tabIndexs).find("select[name='idquanhechuho[]']").attr('tabindex', idquanhechuho_tabindex);
    $("#profile" + tabIndexs).find("select[name='idnghenghiep[]']").attr('tabindex', idnghenghiep_tabindex);
    $("#profile" + tabIndexs).find("select[name='idtrinhdohocvan[]']").attr('tabindex', idtrinhdohocvan_tabindex);
    $("#profile" + tabIndexs).find("select[name='iddantoc[]']").attr('tabindex', iddantoc_tabindex);
    $("#profile" + tabIndexs).find("select[name='idtongiao[]']").attr('tabindex', idtongiao_tabindex);
    $("#profile" + tabIndexs).find("select[name='idquoctich[]']").attr('tabindex', idquoctich_tabindex);

    $("#profile" + tabIndexs).find(".select2").select2();

    $("#profile" + tabIndexs).find(".cke").remove();
    var config = {};
