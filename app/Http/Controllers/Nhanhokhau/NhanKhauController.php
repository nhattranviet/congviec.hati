...
//HO SO HO KHAU - SO HO KHAU
    ...
    public function postDangkythuongtru(Request $request, $idhoso)
    {
        ...
        $idnhankhau = DB::connection('nhanhokhau')->table('tbl_nhankhau')->insertGetId($data_nhankhau);
        $data_sohokhau = array(
        ...
        DB::connection('nhanhokhau')->table('tbl_sohokhau')->insert($data_sohokhau);
    ...
    {
        $data['list_thongtinhokhau'] = DB::connection('nhanhokhau')->table('tbl_sohokhau')
        ->join('tbl_nhankhau', 'tbl_nhankhau.id', '=', 'tbl_sohokhau.idnhankhau')
        ->join('tbl_hoso', 'tbl_hoso.id', '=', 'tbl_sohokhau.idhoso')
        ->where('idhoso', $idhoso)
...
// print_r( $data['list_thongtinhokhau'] ); die;
    ...
    public function getSuanhankhau($id)
    {
        ...
        $this->data['list_quanhechuho'] = DB::connection('nhanhokhau')->table('tbl_moiquanhe')
        ->where(array(
            ['loaiquanhe', '=', 'nhanthan']
        ))
        ->get();
        $this->data['nhankhau'] = DB::connection('nhanhokhau')->table('tbl_nhankhau')
...
// print_r($this->data['nhankhau']); die;
    ...
    {
        $data['nhankhau'] = DB::connection('nhanhokhau')->table('tbl_sohokhau')
        ->join('tbl_nhankhau', 'tbl_nhankhau.id' , '=', 'tbl_sohokhau.idnhankhau')
        ->join('tbl_hoso', 'tbl_hoso.id' , '=', 'tbl_sohokhau.idhoso')
        ->where('tbl_nhankhau.id', $id)
...
// print_r($data['nhankhau']); die;
    ...
    public function xoaThuongtru(Request $request, $idnhankhau)
    {
        ...
        $idhoso = DB::connection('nhanhokhau')->table('tbl_sohokhau')->where('idnhankhau',$idnhankhau)->value('idhoso');

        DB::connection('nhanhokhau')->table('tbl_sohokhau')->where('idnhankhau',$idnhankhau)->delete();
    ...
    public function xoaThuongtruHGD(Request $request, $idhoso)
    {
        ...
        DB::connection('nhanhokhau')->table('tbl_history_cutru')->insert( $data_log_hogiadinh );
