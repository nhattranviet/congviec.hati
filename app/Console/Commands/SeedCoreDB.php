...
class SeedCoreDB extends Command
{
    ...
    public $data_moiquanhe = array(
        ...
        public $data_donvi = [
			["kyhieu" => "Ban Giám đốc", "name" => "Ban Giám đốc", "loaidonvi" => "bgd", "show" => ""],
		    ["kyhieu" => "PV01", "name" => "Phòng tham mưu", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PX01", "name" => "Phòng tổ chức cán bộ", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PX03", "name" => "Phòng công tác Đảng và công tác chính trị", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PX05", "name" => "Phòng thanh tra", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PV06", "name" => "Phòng hồ sơ nghiệp vụ", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PV05", "name" => "Phòng XDPTTDBVANTQ", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PH10", "name" => "Phòng hậu cần", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PA01", "name" => "Phòng ngoại tuyến", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PA02", "name" => "Phòng an ninh nông thôn và phòng chống khủng bố", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PA03", "name" => "Phòng an ninh văn hóa", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PA04", "name" => "Phòng an ninh kinh tế", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PA06", "name" => "Phòng kỹ thuật nghiệp vụ", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PA08", "name" => "Phòng quản lý xuất nhập cảnh", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PA09", "name" => "Phòng an ninh điều tra", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC01", "name" => "Văn phòng cảnh sát điều tra", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC02", "name" => "Phòng cảnh sát hình sự", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC03", "name" => "Phòng cảnh sát kinh tế", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC04", "name" => "Phòng cảnh sát ma túy", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC05", "name" => "Phòng cảnh sát môi trường", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC06", "name" => "Phòng CS Quản lý hành chính", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC07", "name" => "Phòng cảnh sát phòng cháy chữa cháy", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC08", "name" => "Phòng cảnh sát giao thông đường bộ - đường sắt", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC09", "name" => "Phòng kỹ thuật hình sự", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC10", "name" => "Phòng cảnh sát thi hành án và hỗ trợ tư pháp", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PC11", "name" => "Trại tạm giam", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "PK02", "name" => "Phòng cảnh sát cơ động", "loaidonvi" => "phongban", "show" => ""],
			["kyhieu" => "CATP Hà Tĩnh", "name" => "Công an TP Hà Tĩnh", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Thị xã Kỳ Anh", "name" => "CA Thị xã Kỳ Anh", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Kỳ Anh", "name" => "CA Huyện Kỳ Anh", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Cẩm Xuyên", "name" => "CA Huyện Cẩm Xuyên", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Thạch Hà", "name" => "CA Huyện Thạch Hà", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Can Lộc", "name" => "CA Huyện Can Lộc", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Lộc Hà", "name" => "CA Huyện Lộc Hà", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Thị xã Hồng Lĩnh", "name" => "CA Thị xã Hồng Lĩnh", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Đức Thọ", "name" => "CA Huyện Đức Thọ", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Hương Sơn", "name" => "CA Huyện Hương Sơn", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Hương Khê", "name" => "CA Huyện Hương Khê", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Vũ Quang", "name" => "CA Huyện Vũ Quang", "loaidonvi" => "huyentptx", "show" => ""],
			["kyhieu" => "CA Huyện Nghi Xuân", "name" => "CA Huyện Nghi Xuân", "loaidonvi" => "huyentptx", "show" => ""],
        ];
