...
Route::get('/test', function(){
    $id = 1;
    $data = base64_encode( json_encode( ['lydo' => NULL, 'noichuyenden' => 'xóm 10 - Đức Thủy - Đức Thọ - Hà Tĩnh', 'nguoichuyen' => $id, 'nguoichuyencung' => NULL ] ) );
    return redirect()->route('get-hk-07', ['data' => $data]  );
   // $a = '2018-09-11';
...
Route::get('/nhan-khau/{id}/get-hk-03', 'Nhanhokhau\BaocaoThongkeController@getHK03')->name('get-hk-03');
Route::get('/nhan-khau/{id}/get-hk-04', 'Nhanhokhau\BaocaoThongkeController@getHK04')->name('get-hk-04');
Route::get('/nhan-khau/{data}/get-hk-07', 'Nhanhokhau\BaocaoThongkeController@getHK07')->name('get-hk-07');
Route::get('/nhan-khau/{id}/get-hk-07-from-history', 'Nhanhokhau\BaocaoThongkeController@getHK07FromHistory')->name('get-hk-07-from-history');
...
Route::get('/nhat-ky-cong-tac/report-gate-check/', 'NhatkycongtacController@report_nhatkycanbo_gate_check')->name('nhat-ky-cong-tac.report-gate-check');
...
//-------------------BEGIN LỊCH CÔNG TÁC-------------
Route::get('/lich-cong-tac/show/', 'LichcongtacController@show')->name('lich-cong-tac.show');
...
Route::get('/lich-cong-tac/lanh-dao-truc-tuan/', 'LichcongtacController@index_lanhdaotructuan')->name('lich-cong-tac.index_lanhdaotructuan');
