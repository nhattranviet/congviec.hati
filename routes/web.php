...
Route::get('/test', function(){
    $str = "
        ...
        <body>
        <div class=Section1>
        <div id='nhankhautable' class='col-xs-12 loading WordSection1'><div id='page-content' class='WordSection1'>
                    <style>
                        table {
                            width: 100%;
                ...
                <p>Tổng số: 5  hộ; 11 nhân khẩu</p>
                <p>Trong đó: 7  NK thành thị; 5 NK nữ; 5 NK từ 14 tuổi trở lên.</p><h5>II) CÁC LOẠI HỘ, NHÂN KHẨU</h5>
